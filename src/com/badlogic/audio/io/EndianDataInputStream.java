 ...
 * It features simple Wave file reading, mono output to the audio device and a couple of audio analysis
 * classes that facilitate onset detection (FFT, post processing etc.).
 */
